		...
		while(sc.hasNextLine()){
			...
			switch(option.toUpperCase()){
				...
				case("PUBLISH LISTING"):
					...
					//Create an item through a seller
					Listing newItem = seller.createListing(keywords, sellerID, cost, description);
					//Make the broker push the listing and the new seller
					broker.attachSeller(sellerID);
					lastOutput = broker.pushListing(newItem);
